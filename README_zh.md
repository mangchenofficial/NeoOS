...
本项目是基于 **vivo BlueOS** 内核项目的衍生作品。原始 BlueOS 内核由 vivo 移动通信有限公司开发，采用 Apache License 2.0 开源协议。

本项目继续采用 Apache License 2.0 开源协议。详情请参阅 [LICENSE](LICENSE) 文件。

版权致谢和第三方组件归属信息请参阅 [NOTICE](NOTICE) 文件。
